...
<div id="wrapper">
  ...
  <div id="page_main" class="clearfix">
    <div class="page-right">
     <div class="site-nav"><span>当前位置 : </span><a href=".">网站首页</a> &gt;&gt; <a href="javascript:void(0)" >订单评价列表</a></div>
      <div class="page-news">

      <table border="0" align="center">
      <tr><th class="news-time">商品名</th><th class="news-title">评价</th><th class="news-title">评语</th>
      <th class="news-title">评价时间</th>
      <th class="news-title">操作</th></tr>
<c:forEach items="${list}"  var="bean">

<tr><td class="time-list"><span>${bean.product.pname }</span></td>
<td align="center">${bean.pingjia }</td>
<td align="center">${bean.pingyu }</td>
<td align="center">${bean.createtime }</td>
<td align="center">
<c:if test="${bean.pingjia==null}">
<a href="${url2 }add?id=${bean.id }">评价</a> &nbsp; 
</c:if>
