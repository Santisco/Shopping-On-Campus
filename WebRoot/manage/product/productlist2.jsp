...
<TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=1>
    ...
    <TD align="center" >好评</TD>
    <TD align="center" >中评</TD>
    ...
    <TD align="center" >${bean.haoping }</TD>
    <TD align="center" >${bean.zhongping }</TD>
    <TD align="center" >${bean.chaping }</TD>


    <TD align="center"> 
  	<a href="method!pingjialist?pid=${bean.id }">查看评价列表</a> &nbsp; 
